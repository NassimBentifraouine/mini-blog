<svg {{ $attributes }} version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 437.5 437.5" enable-background="new 0 0 437.5 437.5" xml:space="preserve">
<g>
    <path fill="#FF9800" d="M437.5,406.2c0,17.2-14,31.2-31.2,31.2h-375C14,437.5,0,423.5,0,406.2v-375C0,14,14,0,31.2,0h375
		c17.2,0,31.2,14,31.2,31.2V406.2z"/>
    <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="1037.974" y1="-220.1406" x2="1449.1095" y2="-631.276" gradientTransform="matrix(0.5 0 0 -0.5 -370.125 59.625)">
    ...
    <radialGradient id="SVGID_2_" cx="763.4896" cy="103.2396" r="1186.0625" gradientTransform="matrix(0.5 0 0 -0.5 -370.125 59.625)" gradientUnits="userSpaceOnUse">
